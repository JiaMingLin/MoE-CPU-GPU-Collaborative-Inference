MODEL=$HOME/llm/models/phi-3.5-moe
FIXLEN=64
LEN=480
...
python -u ../src/phi.py --prompt 'implement a red-black tree using C++ and show me the  example usage' --model-path $MODEL --max-tokens $FIXLEN  $@
